    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="container" id="certificateChartContainer">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            fetch('{{ route("dashboard.chartData") }}')
                ...
                .then(data => {
                    ...
                    if (!data.data || data.data.length === 0 || data.data.every(value => value === 0)) {
                        var container = document.getElementById('certificateChartContainer');
                        container.innerHTML = '<p>Não há certificados cadastrados.</p>';
                    } else {
