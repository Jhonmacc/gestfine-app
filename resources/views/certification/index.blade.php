                        ...
                        @endphp
                            <tr>
                                ...
                                <td class="numero-column" style="width: 200px; white-space: nowrap;">
                                    <input type="text" value="{{ $certificate->numero }}" style="width: 150px; white-space: nowrap;" class="form-control numero-input numero-input-mask" data-id="{{ $certificate->id }}" />
                                </td>
